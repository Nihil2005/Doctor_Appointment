...
SECRET_KEY = "django-insecure-dh#x9-mpiz)i3!5%ngp8i0d!*l&-bv2u4b&n)i+-j#a&os%7$m"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
AUTH_USER_MODEL = 'myheath.CustomUser'
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = False  # Sessions expire when the user closes their browser
